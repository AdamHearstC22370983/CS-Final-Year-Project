            ...
            <div className="row align-items-center g-4">
              <div className="col-lg-7">
                ...
                <p className="lead text-muted mb-4">
                  Skillgap compares a user’s CV against a target job description, highlights your 
            ...
            <>
              <div className="row align-items-center g-4 mb-4">
                <div className="col-lg-12">
                  ...
                  <p className="lead text-muted mb-4 home-logged-in-intro">
                    Start a new analysis or jump straight back into reviewing your skill gap and
                  ...
                  <div className="d-flex flex-wrap gap-3">
                    ...
                    <Link to="/recommendations" className="btn btn-outline-primary btn-lg">
              ...
              <div className="row g-4">
                <div className="col-md-4">
                  <div className="card border-0 shadow-sm h-100 home-feature-card">
                    <div className="card-body p-4">
